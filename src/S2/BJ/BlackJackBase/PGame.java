...
public final class PGame extends JPanel {
	 ...
	 */
	public static void run(PDeck deck, PGame dealer, PGame player) {
	...
	private PDeck deck;
	private PGame dealer;
	private PGame player;
	private Status status;
	private Button hitButton;
	private Button standButton;;
	private Button restartButton;

	private PGame(PDeck deck, PGame dealer, PGame player) {
		this.deck = deck;
		this.dealer = dealer;
		this.player = player;
